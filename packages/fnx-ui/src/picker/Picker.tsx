...
const InternalPicker: ForwardRefRenderFunction<PickerRef, PickerProps> = (
	_props,
	ref,
) => {
	const [
...
const Picker = forwardRef<PickerRef, PickerProps>(InternalPicker) as <
	T extends PickerOptionOrValue,
>(
