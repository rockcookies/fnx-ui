...
const InternalStepper = forwardRef<StepperRef, StepperProps>((_props, ref) => {
	...
	const stepClick = useMergedPropRef(
...
const Stepper = InternalStepper as <T extends StepperValue = StepperValue>(
