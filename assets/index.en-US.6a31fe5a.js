const n={},a=`<h1 id="space" tabindex="-1">Space</h1>
<p>Set components spacing.</p>
<h2 id="basic-usage" tabindex="-1">Basic Usage</h2>
<p>Crowded components spacing, default space is <code v-pre>8px</code>.</p>
...
<p>Use <code v-pre>direction</code> property to change components vertical spacing.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Space<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<p>Use <code v-pre>size</code> property to change components spacing.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Space<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<p>Use <code v-pre>align</code> property to change alignment of components.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Space<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<tr>
<td>size</td>
<td>Spacing size, such as <code v-pre>20px</code> <code v-pre>2em</code>. The default unit is <code v-pre>px</code>, supports using array to set horizontal and vertical spacing</td>
...
<tr>
<td>wrap</td>
<td>Whether to wrap automatically, only for horizontal alignment</td>
...
<tr>
<td>fill</td>
<td>Whether to render Space as a block element and fill the parent element</td>
<td><code v-pre>boolean</code></td>
<td><code v-pre>false</code></td>
<td></td>
</tr>
