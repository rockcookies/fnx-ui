const n={},s=`<h1 id="grid" tabindex="-1">Grid</h1>
...
<p>Use <code v-pre>columnSize</code> property to set the grid column size.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Grid <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<p>Use <code v-pre>square</code> property to set square grid item.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Grid <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<p>Set the distance between the Grid.Item via the <code v-pre>gutter</code> property.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Grid <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<h2 id="with-badge" tabindex="-1">With Badge</h2>
...
<tr>
<td>gutter</td>
<td>The spacing between items, the default unit is <code v-pre>px</code></td>
<td><code v-pre>number | string</code></td>
