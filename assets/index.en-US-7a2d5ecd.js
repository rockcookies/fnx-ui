const n={},a=`<h1 id="badge" tabindex="-1">Badge</h1>
<p>Small numerical value or status descriptor for UI elements.</p>
<h2 id="basic-usage" tabindex="-1">Basic Usage</h2>
<p>Set <code v-pre>count</code> prop to display the corresponding content in the upper right corner of the child element, or set <code v-pre>dot</code> to display small red dots.</p>
...
<h2 id="overflow" tabindex="-1">Overflow</h2>
<p>Set <code v-pre>max</code> prop to handle overflow situation.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Badge <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<p>You can also set it to a hex color string for custom color through <code v-pre>color</code> property.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Badge <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<h2 id="custom-content" tabindex="-1">Custom Content</h2>
<p><code v-pre>count</code> prop support custom element.</p>
...
<p>Use <code v-pre>position</code> prop to set the position of badge.</p>
<pre class="language-tsx"><code class="language-tsx" v-pre><span class="token keyword">import</span> <span class="token punctuation">{</span> Badge <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'fnx-ui'</span><span class="token punctuation">;</span>
...
<tr>
<td>showZero</td>
<td>Whether to show badge when <code v-pre>count</code> is zero</td>
...
<tr>
<td>max</td>
<td>Max value, show <code v-pre>{max}+</code> when exceed, only works when <code v-pre>count</code> is number</td>
